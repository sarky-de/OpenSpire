...
export class Battle {
    ...
    protected initGameStateManager(): void {
        this._stateManager
            .Add(Battle.PHASE_BATTLE_START, new StartBattlePhase(this), [ Battle.PHASE_TURN_START ])
            .Add(Battle.PHASE_TURN_START, new StartTurnPhase(this), [ Battle.PHASE_TURN_PLAY ])
            .Add(Battle.PHASE_TURN_PLAY, new PlayTurnPhase(this), [ Battle.PHASE_TURN_END ])
            .Add(Battle.PHASE_TURN_END, new EndTurnPhase(this), [ Battle.PHASE_TURN_START, Battle.PHASE_BATTLE_END] )
